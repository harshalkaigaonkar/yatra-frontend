  ...
  return (
    <View style={{flex: 1}}>
      ...
      <Agenda
        ...
        markingType="period"
        markedDates={{
          '2022-10-15': {startingDay: true, color: '#70d7c7', textColor: 'white'},
          '2022-10-16': {color: '#70d7c7', textColor: 'white', endingDay: true},
          '2022-10-17': {color: '#70d7c7', textColor: 'white', marked: true, dotColor: 'white', startingDay: true},
          '2022-10-18': {color: '#70d7c7', textColor: 'white'},
          '2022-10-19': {endingDay: true, color: '#50cebb', textColor: 'white'}
              }}
      />
    </View>
  );
